...
<div className="lg:w-[78%] w-full bg-white p-6 lg:p-10 overflow-hidden">
  ...
  <div className="flex justify-between items-center">
    ...
    <div className="hidden md:block w-[280px] border rounded-lg shadow p-4">
      ...
      <h3 className="mt-3 font-semibold text-gray-800">Current Rank ⭐</h3>

      <div className="mt-2 text-sm">
        <p className="flex justify-between"><span>Java Arrays</span> <span className="font-bold">68/100</span></p>
        <p className="flex justify-between"><span>React Hooks</span> <span className="font-bold">82/100</span></p>
        <p className="flex justify-between"><span>Python Basics</span> <span className="font-bold">77/100</span></p>
      </div>
    </div>
  </div>
  ...
  <div className="flex gap-4 mt-6 flex-wrap">
    <div className="border rounded-lg shadow bg-white px-6 py-4">
      <p className="text-gray-500 text-sm">Completed</p>
      <h2 className="text-2xl font-bold text-blue-600">7</h2>
    </div>
    ...
    <div className="border rounded-lg shadow bg-white px-6 py-4">
      ...
      <h2 className="text-2xl font-bold text-blue-600">78</h2>
    </div>
  </div>
  ...
  <div className="mt-6">
    ...
    <div className="flex gap-3 flex-wrap">
      <button className="border px-5 py-2 rounded-md shadow hover:bg-blue-200">Easy</button>
      <button className="border px-5 py-2 rounded-md shadow hover:bg-blue-200">Medium</button>
      <button className="border px-5 py-2 rounded-md shadow hover:bg-blue-200">Hard</button>
    </div>
  </div>
  ...
  <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="border rounded-lg p-4 shadow bg-white">
      <div className="flex justify-between">
        <h3 className="font-semibold text-gray-800">Frontend Interview Prep</h3>
    ...
    <div className="border rounded-lg p-4 shadow bg-white">
      <div className="flex justify-between">
        <h3 className="font-semibold text-gray-800">Algorithm Challenge</h3>
